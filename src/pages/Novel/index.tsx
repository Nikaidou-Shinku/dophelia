  ...
  return (
    <div class="flex justify-center px-4">
      <div class="flex flex-col items-center gap-y-4">
        <div class="flex w-full items-center rounded-lg border border-gray-200 lg:items-start">
          <Switch>
            ...
            <Match when={novelQuery.isSuccess}>
              <Show
                ...
                fallback={
                  <div class="flex w-full flex-col gap-y-4 px-24 py-12 text-center">
              ...
              >
                {(novel) => (
                  <>
                    ...
                    <div class="flex basis-3/5 flex-col gap-y-2 p-4 lg:basis-3/4">
        ...
        <Switch>
          <Match when={chaptersQuery.isPending}>
            <div class="w-full border border-gray-200 py-24 text-center">
              <span class="text-2xl">Loading...</span>
            </div>
          </Match>
          ...
          <Match when={chaptersQuery.isSuccess}>
            <Show when={chaptersQuery.data!.length > 0}>
              <div class="flex w-full flex-col gap-y-4 lg:flex-row lg:gap-x-4 lg:gap-y-0">
                <div class="flex items-center justify-around gap-x-2 rounded-lg border border-gray-200 p-4 lg:flex-col lg:gap-x-0">
                  <button
                ...
                <div class="flex-1 rounded-lg border border-gray-200 p-8 lg:p-4">
                  <Heatmap
